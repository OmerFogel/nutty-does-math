const translations = {
  ...
  he: {
    title: 'אגוז עושה חשבון!',
    subtitle: '!עזור לאגוז לאסוף אגוזים לפני החורף',
    play: '!בואו נשחק',
    level: 'שלב',
    score: 'ניקוד',
    walnuts: 'אגוזים',
    ...
    levelCompleteMsg: '!אגוז אסף את כל האגוזים! הגיע הזמן לאתגר הבא',
    victory: '!ניצחת 🏆',
    victoryMsg: '!לאגוז יש מספיק אגוזים לכל החורף! אתה גאון במתמטיקה',
    playAgain: 'שחק שוב',
